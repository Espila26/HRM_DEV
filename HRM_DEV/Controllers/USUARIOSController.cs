...
namespace HRM_DEV.Controllers
{
    public class USUARIOSController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_USUARIO,NOMBRE_USUARIO,CONTRASEÑA,ESTADO,ACC_EMPRESA,ACC_DEPART,ACC_PUESTOS,ACC_EMPLEADOS,ACC_ACCIONES,ACC_USUARIO,ROL")] USUARIOS uSUARIOS)
        {
        ...
        public ActionResult formAction(string[] childChkbox)
        {
            ...
            else
            {
                if (Request.Form["Detalles"] != null)
                {
                    ...
                    {
                        return RedirectToAction("Details", "USUARIOS", new { id = childChkbox.First() });
                    }
                    else
                    {
                ...
                else if (Request.Form["Editar"] != null)
                {
                    ...
                    if (childChkbox.Count() == 1)
                    {
                        return RedirectToAction("Edit", "USUARIOS", new { id = childChkbox.First() });
                    }
                    else
                    {
